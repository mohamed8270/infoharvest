...
const Modal = ({productId}: Props) => {
  ...
  return (
    <>
        <button type="button" className='py-4 px-4 bg-Iblack hover:bg-opacity-70 rounded-[30px] text-white text-lg font-semibold' onClick={openModal}>
            Track
        </button>
            ...
            leaveTo="opacity-0 scale-95">
                <div className='p-6  bg-white inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform  shadow-xl rounded-2xl'>
                    <div className='flex flex-col'>
                        <div className='flex justify-between'>
                            <div className='p-3 border border-gray-200 rounded-[10px]'>
                                <p className='text-Iblack text-[12px] font-semibold'>Info <span className='text-Ired font-semibold'>Harvest</span> </p>
                            </div>
                            <Image
                        ...
                        <h4 className='text-Iblack font-poppins text-lg leading-[24px] font-semibold mt-4'>
                            Stay updated with product pricing alerts right in your inbox
                        </h4>

                        <p className='text-gray-600 mt-2 font-poppins font-light text-sm'>
                    ...
                    <form className='flex flex-col mt-5' onSubmit={handleSubmit}>
                        ...
                        <button type="submit"
                        className='px-5 py-3 text-white text-base font-semibold border border-secondary bg-Iblack rounded-lg mt-8'>
